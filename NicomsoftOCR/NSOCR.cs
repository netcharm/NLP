...
namespace NSOCR_NameSpace
{
    public class TNSOCR
    {
        ...
        //for x86
        public const string LIBNAME = "NSOCR.dll"; //IMPORTANT: CORRECT PATH TO X86 NSOCR.DLL
        //for x64
        //public const string LIBNAME = "NSOCR.dll"; //IMPORTANT: CORRECT PATH TO X64 NSOCR.DLL
